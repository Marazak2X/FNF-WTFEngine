...
class FunkinLua {
	...
	public function new(script:String) {
		...
		set('ratingName', '');
		set('ratingFC', '');
		set('versionPE', MainMenuState.psychEngineVersion.trim());
		set('versionWE', MainMenuState.wtfEngineVersion.trim());
		...
		Lua_helper.add_callback(lua, "doTweenSongLength", function(tag:String, vars:String, value:Dynamic, duration:Float, ease:String) {
		...
		Lua_helper.add_callback(lua, "addCBreaks", function(value:Int = 0) {
		...
		Lua_helper.add_callback(lua, "setCBreaks", function(value:Int = 0) {
			PlayState.instance.songBreaks += value;
			PlayState.instance.RecalculateRating();
		});
		...
		Lua_helper.add_callback(lua, "getCBreaks", function() {
			return PlayState.instance.songBreaks;
		});
		Lua_helper.add_callback(lua, "getHits", function() {
			return PlayState.instance.songHits;
		});

		Lua_helper.add_callback(lua, "addSicks", function(value:Int = 0) {
			PlayState.instance.sicks += value;
			PlayState.instance.RecalculateRating();
		});
		Lua_helper.add_callback(lua, "addGoods", function(value:Int = 0) {
			PlayState.instance.goods += value;
			PlayState.instance.RecalculateRating();
		});
		Lua_helper.add_callback(lua, "addBads", function(value:Int = 0) {
			PlayState.instance.bads += value;
			PlayState.instance.RecalculateRating();
		});
		Lua_helper.add_callback(lua, "addShits", function(value:Int = 0) {
			PlayState.instance.shits += value;
			PlayState.instance.RecalculateRating();
		});
		Lua_helper.add_callback(lua, "setSicks", function(value:Int = 0) {
			PlayState.instance.sicks = value;
			PlayState.instance.RecalculateRating();
		});
		Lua_helper.add_callback(lua, "setGoods", function(value:Int = 0) {
			PlayState.instance.goods = value;
			PlayState.instance.RecalculateRating();
		});
		Lua_helper.add_callback(lua, "setBads", function(value:Int = 0) {
			PlayState.instance.bads = value;
			PlayState.instance.RecalculateRating();
		});
		Lua_helper.add_callback(lua, "setShits", function(value:Int = 0) {
			PlayState.instance.shits = value;
			PlayState.instance.RecalculateRating();
		});
		Lua_helper.add_callback(lua, "getSicks", function() {
			return PlayState.instance.sicks;
		});
		Lua_helper.add_callback(lua, "getGoods", function() {
			return PlayState.instance.goods;
		});
		Lua_helper.add_callback(lua, "getBads", function() {
			return PlayState.instance.bads;
		});
		Lua_helper.add_callback(lua, "getShits", function() {
			return PlayState.instance.shits;
		});
		...
		Lua_helper.add_callback(lua, "keyJustPressed", function(name:String) {
			...
			switch(name) {
				...
				case '0': key = FlxG.keys.justPressed.ZERO;
				case '1': key = FlxG.keys.justPressed.ONE;
				case '2': key = FlxG.keys.justPressed.TWO;
			}
			return key;
		});
