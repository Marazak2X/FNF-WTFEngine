...
class PlayState extends MusicBeatState
{
	...
	public static var campaignBreaks:Int = 0;
	public static var seenCutscene:Bool = false;
	public static var deathCounter:Int = 0;

	var screenZoom:FlxTween;
	...
	override public function create()
	{
		...
		{
			case 'tutorial':
				timeBar.createFilledBar(0xFF000000, 0xFFF1194F);
			case 'bopeebo':
				timeBar.createFilledBar(0xFF000000, 0xFF9E0CE2);
			case 'fresh':
				timeBar.createFilledBar(0xFF000000, 0xFF9E0CE2);
			case 'dad-battle':
				timeBar.createFilledBar(0xFF000000, 0xFF9E0CE2);
			case 'spookeez':
				timeBar.createFilledBar(0xFF000000, 0xFFE2850C);
			case 'south':
				timeBar.createFilledBar(0xFF000000, 0xFFE2850C);
			case 'monster':
				timeBar.createFilledBar(0xFF000000, 0xFFD4E20C);
			case 'pico':
				timeBar.createFilledBar(0xFF000000, 0xFFAAE944);
			case 'philly-nice':
				timeBar.createFilledBar(0xFF000000, 0xFFAAE944);
			case 'blammed':
				timeBar.createFilledBar(0xFF000000, 0xFFAAE944);
			case 'satin-panties':
				timeBar.createFilledBar(0xFF000000, 0xFFE444E9);	
			case 'high':
				timeBar.createFilledBar(0xFF000000, 0xFFE444E9);	
			case 'milf':
				timeBar.createFilledBar(0xFF000000, 0xFFE444E9);
			case 'cocoa':
				timeBar.createFilledBar(0xFF000000, 0xFF44C3E9);
			case 'eggnog':
				timeBar.createFilledBar(0xFF000000, 0xFF44C3E9);	
			case 'winter-horrorland':
				timeBar.createFilledBar(0xFF000000, 0xFFE9E644);	
			case 'senpai':
				timeBar.createFilledBar(0xFF000000, 0xFFE98644);	
			case 'roses':
				timeBar.createFilledBar(0xFF000000, 0xFFE98144);
			case 'thorns':
				timeBar.createFilledBar(0xFF000000, 0xFFE9446D);
			case 'ugh':
				timeBar.createFilledBar(0xFF000000, 0xFFE9AF44);	
			case 'guns':
				timeBar.createFilledBar(0xFF000000, 0xFFE9A744);	
			case 'stress':
				timeBar.createFilledBar(0xFF000000, 0xFFE9C344);	
		}
		...
		sicksTxt = new FlxText(-560, 300, FlxG.width, '', 20);
		sicksTxt.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		sicksTxt.scrollFactor.set();
		sicksTxt.borderSize = 1.25;
		sicksTxt.visible = !ClientPrefs.hideHud;
		if(!ClientPrefs.hideRating)
			add(sicksTxt);

		goodsTxt = new FlxText(-560, 325, FlxG.width, '', 20);
		goodsTxt.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		badsTxt = new FlxText(-560, 350, FlxG.width, '', 20);
		badsTxt.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		shitsTxt = new FlxText(-560, 375, FlxG.width, '', 20);
		shitsTxt.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		missesTxt = new FlxText(-560, 400, FlxG.width, '', 20);
	...
	public function updateScore(miss:Bool = false)
	{
		...
		if(ClientPrefs.scoreZoom && !miss && !cpuControlled)
		{
			...
			sicksTxt.scale.x = 1.1;
			sicksTxt.scale.y = 1.1;
			goodsTxt.scale.x = 1.1;
		    goodsTxt.scale.y = 1.1;
			badsTxt.scale.x = 1.1;
			badsTxt.scale.y = 1.1;
			shitsTxt.scale.x = 1.1;
			shitsTxt.scale.y = 1.1;
			missesTxt.scale.x = 1.1;
			missesTxt.scale.y = 1.1;
			scoreTxt.scale.x = 1.075;
			scoreTxt.scale.y = 1.075;
			ratingTxtTween = FlxTween.tween(sicksTxt.scale, {x: 1, y: 1}, 0.2, {
				onComplete: function(twn:FlxTween) {
					ratingTxtTween = null;
				}
			});
			ratingTxtTween = FlxTween.tween(goodsTxt.scale, {x: 1, y: 1}, 0.2, {
				onComplete: function(twn:FlxTween) {
					ratingTxtTween = null;
				}
			});
			ratingTxtTween = FlxTween.tween(badsTxt.scale, {x: 1, y: 1}, 0.2, {
				onComplete: function(twn:FlxTween) {
					ratingTxtTween = null;
				}
			});
			ratingTxtTween = FlxTween.tween(shitsTxt.scale, {x: 1, y: 1}, 0.2, {
				onComplete: function(twn:FlxTween) {
					ratingTxtTween = null;
				}
			});
			ratingTxtTween = FlxTween.tween(missesTxt.scale, {x: 1, y: 1}, 0.2, {
				onComplete: function(twn:FlxTween) {
					ratingTxtTween = null;
				}
			});
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Cam Zoom Tween':
				...
				var targetZoom:Float = Std.parseFloat(value1);
				...
				if(duration == 0) {
					...
					screenZoom = FlxTween.tween(FlxG.camera, {zoom: targetZoom}, duration, {ease:FlxEase.quadInOut});
				}
	...
	public function spawnNoteSplash(x:Float, y:Float, data:Int, ?note:Note = null) {
		...
		if(isPixelStage) skin = 'pixelUI/noteSplashes';
	...
	public function RecalculateRating(badHit:Bool = false) {
		...
		if(ret != FunkinLua.Function_Stop)
		{
			...
			if (songBreaks > 0 && songBreaks < 10) ratingFC = "SDCB";
			else if (songBreaks >= 10) ratingFC = "Clear";
		}
	...
	private function checkForAchievement(achievesToCheck:Array<String> = null):String
	{
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				{
					if(isStoryMode && campaignBreaks + songBreaks < 1 && campaignMisses + songMisses < 1 && CoolUtil.difficultyString() == 'HARD'
	...
	public function startScript()
	{
		...
		#if MODS_ALLOWED
		path = Paths.modsHscript(formattedFolder + '/script');
		#else
		path = Paths.hscript(formattedFolder + '/script');
		#end
		...
		if (hxdata != "")
		{
			...
			script.setVariable("LEFT", FlxTextAlign.LEFT);
			script.setVariable("RIGHT", FlxTextAlign.RIGHT);
