...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addNoteUI():Void
	{
		...
		#if MODS_ALLOWED
		directories.push(Paths.mods('notes/'));
		directories.push(Paths.mods(Paths.currentModDirectory + '/notes/'));
		for(mod in Paths.getGlobalMods())
			directories.push(Paths.mods(mod + '/notes/'));
		#end
